create or replace view v_prl_isf as			
select i.entgid,			
       i.ISFFlowType,			
       i.ISFModelGid,			
       i.ISFModelCode,			
       ...
       i.ISFStatText,			
       i.ISFDepeCode,			
       i.lesseegid ISFlesseegid,			
       i.lessee ISFlessee,			
       i.TradingGid ISFTradingGid,			
  ...
  from (select f.entgid,			
               ...
               decode(f.stat,			
                      ...
                      f.Stat) ISFStatText,			
               f.stat ISFStat,			
               substr(f.FILLUSRDEPTCODE, 0, 4) ISFDepeCode			
          from wf_prl_isf f, wf_flow wf, wf_model wm			
       ...
       (select f.entgid,			
               ...
               decode(wf.stat,			
                      ...
                      '已超时') ISTFFStat,			
               f.oldflowgid			
          from wf_prl_istf f, wf_flow wf, wf_model wm			
         where f.entgid = wf.entgid			
           and f.flowgid = wf.flowgid			
           and f.Entgid = wm.EntGid			
           and wf.ModelGid = wm.ModelGid			
