alter table Wf_Prl_Stamp modify StampType varchar(128);

update WF_Prl_Stamp set StampType = '财务印章' where StampType = '公司股东或财务印章';

update Prl_Stamp_App set StampType = '财务印章' where StampType = '公司股东或财务印章';
