...
--4、定义工作流程名称 ，步骤等
  ...
  select v_EntGid, v_ModelGid, v_ModelCode, '通用审批流程', 3, '1.审批流程', '1.0', 0, 0 from dual;
...
drop table WF_Prl_Common;			
create table WF_Prl_Common (			
	...
	constraint PK_WF_Prl_Common primary key(EntGid, FlowGid),		
	CONSTRAINT UNQ_Prl_Common UNIQUE(Num)		
	);		
create index idx_WF_Prl_Common_1 on WF_Prl_Common(FillUsrGid);			
			
drop table WF_Prl_Common_App;			
create table WF_Prl_Common_App (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	...
	AppDate	date	null,
	constraint PK_WF_Prl_Common_App primary key(EntGid, FlowGid, Gid)		
	);		
			
			
drop table WF_Prl_Common_Attach;			
create table WF_Prl_Common_Attach (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	AttachSize	int	null,
	constraint PK_WF_Prl_Common_Attach primary key(EntGid, FlowGid, Gid)		
	);		
