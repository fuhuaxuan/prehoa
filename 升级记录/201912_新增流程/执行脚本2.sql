...
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prldz_areaset','项目报规设置','DOA管理','30','/bin/hdnet.dll/__explainmodule?url=prldz_areaset','800448','项目报规设置');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prldz_areasetsave','项目报规设置','DOA管理','30','/bin/hdnet.dll/__explainmodule?url=prldz_areasetsave','800449','项目报规设置');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prldz_arealist','项目报规查询','DOA管理','30','/bin/hdnet.dll/__explainmodule?url=prldz_arealist','800450','项目报规查询');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prldz_areadtl','项目报规查询','DOA管理','30','/bin/hdnet.dll/__explainmodule?url=prldz_areadtl','800451','项目报规查询');
...
begin
  ...
  for R in (select f.*, wm.name ModelName
    ...
    v_Body    := v_Body || '<td>'|| R.ProjectDate ||'年面积</td>';
