drop table Prl_Stamp;			
create table Prl_Stamp (			
	...
	constraint PK_Prl_Stamp primary key(EntGid, Gid)		
	);		

drop table PrlZB_Stamp;			

create table PrlZB_Stamp (			
	EntGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	CreateDate	date	default sysdate not null,
	LastUpdDate	date	default sysdate not null,
	...
	AppCode	Varchar2(64)	null,
	AppName	Varchar2(64)	null,
	constraint PK_PrlZB_Stamp primary key(EntGid, Gid)		
	);		


drop table WF_PrlZB_Stamp_Attach2;			
create table WF_PrlZB_Stamp_Attach2 (			
	EntGid 	varchar2(32)	not null,
	...
	AttachSize	int	null,
	constraint PK_WF_PrlZB_Stamp_Attach2 primary key(EntGid, FlowGid, Gid)		
	);		

drop table WF_Prl_Stamp_Attach2;			
create table WF_Prl_Stamp_Attach2 (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	AttachUrl	varchar2(1024)	null,
	AttachSize	int	null,
	constraint PK_WF_Prl_Stamp_Attach2 primary key(EntGid, FlowGid, Gid)		
	);		
