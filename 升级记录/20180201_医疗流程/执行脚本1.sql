...
drop table WF_PrlYY_BaoXiao;			
create table WF_PrlYY_BaoXiao (			
	...
	constraint PK_WF_PrlYY_BaoXiao primary key(EntGid, FlowGid),		
	CONSTRAINT UNQ_PrlYY_BaoXiao UNIQUE(Num)		
	);		
create index idx_WF_PrlYY_BaoXiao_1 on WF_PrlYY_BaoXiao(FillUsrGid);			
			
drop table WF_PrlYY_BaoXiao_Dtl;			
create table WF_PrlYY_BaoXiao_Dtl (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	...
	constraint PK_WF_PrlYY_BaoXiao_Dtl primary key(EntGid, FlowGid, Gid)		
	);		
			
drop table WF_PrlYY_BaoXiao_App;			
create table WF_PrlYY_BaoXiao_App (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	AppDate	date	null,
	constraint PK_WF_PrlYY_BaoXiao_App primary key(EntGid, FlowGid, Gid)		
	);		
			
			
drop table WF_PrlYY_BaoXiao_Attach;			
create table WF_PrlYY_BaoXiao_Attach (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	...
	constraint PK_WF_PrlYY_BaoXiao_Attach primary key(EntGid, FlowGid, Attach_Gid)		
	);		


drop table WF_PrlYY_Fee;			
create table WF_PrlYY_Fee (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Num	varchar2(32)	null,
	...
	Enddate	date	null,
	EndMemo	varchar2(2000)	null,
	constraint PK_WF_PrlYY_Fee primary key(EntGid, FlowGid),		
	CONSTRAINT UNQ_PrlYY_Fee UNIQUE(Num)		
	);		
create index idx_WF_PrlYY_Fee_fillgid on WF_PrlYY_Fee(FillUsrGid);			
			
drop table WF_PrlYY_Fee_dtl;			
create table WF_PrlYY_Fee_dtl (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	vendorfee5	NUMBER	null,
	vendorfee6	NUMBER	null,
	constraint PK_WF_PrlYY_Fee_dtl primary key(EntGid, FlowGid, Gid)		
	);		
			
			
drop table WF_PrlYY_Fee_App;			
create table WF_PrlYY_Fee_App (			
	EntGid 	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	...
	AppDate	date	null,
	constraint PK_WF_PrlYY_Fee_App primary key(EntGid, FlowGid,dtlGid)		
	);		
			
			
drop table WF_PrlYY_Fee_Attach;			
create table WF_PrlYY_Fee_Attach (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Attach_Gid	varchar2(32)	not null,
	...
	Attach_Url	varchar2(1024)	null,
	Attach_Size	int	null,
	constraint PK_WF_PrlYY_Fee_Attach primary key(EntGid, FlowGid, Attach_Gid)		
	);		
drop table WF_PrlYY_PAY;			
create table WF_PrlYY_PAY (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Num	varchar2(32)	null,
	...
	AreaFlag	varchar2(64)	null,
	EndMemo	varchar2(2000)	null,
	constraint PK_WF_PrlYY_PAY primary key(EntGid, FlowGid),		
	CONSTRAINT UNQ_PrlYY_PAY UNIQUE(Num)		
	);		
create index idx_WF_PrlYY_PAY_fillgid on WF_PrlYY_PAY(FillUsrGid);			
			
drop table WF_PrlYY_PAY_App;			
create table WF_PrlYY_PAY_App (			
	EntGid 	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	dtlgid	varchar2(32)	not null,
	--		
	...
	note	varchar2(4000)	null,
	AppDate	date	null,
	constraint PK_WF_PrlYY_PAY_App primary key(EntGid, FlowGid,dtlGid)		
	);		
			
			
drop table WF_PrlYY_PAY_Attach;			
create table WF_PrlYY_PAY_Attach (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Attach_Gid	varchar2(32)	not null,
	...
	Attach_Url	varchar2(1024)	null,
	Attach_Size	int	null,
	constraint PK_WF_PrlYY_PAY_Attach primary key(EntGid, FlowGid, Attach_Gid)		
	);		
			
			
--版本号：2014年3月份;此行不允许删除			
drop table WF_PrlYY_Stamp;			
create table WF_PrlYY_Stamp (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Num	varchar2(32)	null,
	...
	Memo	varchar2(2000)	null,
	constraint PK_WF_PrlYY_Stamp primary key(EntGid, FlowGid),		
	CONSTRAINT UNQ_PrlYY_Stamp UNIQUE(Num)		
	);		
create index idx_WF_PrlYY_Stamp_1 on WF_PrlYY_Stamp(FillUsrGid);			
			
drop table WF_PrlYY_Stamp_App;			
create table WF_PrlYY_Stamp_App (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	AppMemo	varchar2(4000)	null,
	AppDate	date	null,
	constraint PK_WF_PrlYY_Stamp_App primary key(EntGid, FlowGid, Gid)		
	);		
			
			
drop table WF_PrlYY_Stamp_Attach;			
create table WF_PrlYY_Stamp_Attach (			
	EntGid 	varchar2(32)	not null,
	ModelGid	varchar2(32)	not null,
	FlowGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	...
	AttachSize	int	null,
	constraint PK_WF_PrlYY_Stamp_Attach primary key(EntGid, FlowGid, Gid)		
	);		
			
			
			
			
drop table PrlYY_Stamp_App;			
create table PrlYY_Stamp_App (			
	EntGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	CreateDate	date	default sysdate not null,
	LastUpdDate	date	default sysdate not null,
	...
	AppCode	Varchar2(64)	null,
	AppName	Varchar2(64)	null,
	constraint PK_PrlYY_Stamp_App primary key(EntGid, Gid)		
	);		
			

drop table PrlYY_COMPANY;			
create table PrlYY_COMPANY(			
	EntGid 	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	--		
	...
	constraint PK_PrlYY_COMPANY primary key(EntGid, Gid)		
	);		
			
drop table PrlYY_ACG;			
create table PrlYY_ACG (			
	EntGid 	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	--		
	...
	constraint PK_PrlYY_ACG primary key(EntGid, Gid)		
	);		
			
drop table PrlYY_Post;			
create table PrlYY_Post(			
	EntGid 	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	--		
	CODE	int	null,
	NAME	varchar2(512)	null,
	constraint PK_PrlYY_Post primary key(EntGid, Gid)		
	);		
			
drop table PrlYY_App;			
create table PrlYY_App (			
	EntGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	CreateDate	date	default sysdate not null,
	LastUpdDate	date	default sysdate not null,
	...
	AppCode	Varchar2(64)	null,
	AppName	Varchar2(64)	null,
	constraint PK_PrlYY_App primary key(EntGid, Gid)		
	);		
			
drop table PrlYY_Acg_Post;			
create table PrlYY_Acg_Post (			
	EntGid	varchar2(32)	not null,
	Gid	varchar2(32)	not null,
	CreateDate	date	default sysdate not null,
	LastUpdDate	date	default sysdate not null,
	...
	constraint PK_PrlYY_Acg_Post primary key(EntGid, Gid)		
	);		
