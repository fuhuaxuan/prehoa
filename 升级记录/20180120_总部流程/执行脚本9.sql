...
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prlzb_app','流程审批设置','总部流程管理','30','/bin/hdnet.dll/__explainmodule?url=prlzb_app','800503','流程设置');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prlzb_appsave','流程审批设置','总部流程管理','30','/bin/hdnet.dll/__explainmodule?url=prlzb_appsave','800504','流程设置');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prlzb_acg_post','项目审批设置','总部流程管理','30','/bin/hdnet.dll/__explainmodule?url=prlzb_acg_post','800505','流程设置');
insert into rt(id,name,atype,alevel,url,aorder,memo) values('prlzb_acg_postsave','项目审批设置','总部流程管理','30','/bin/hdnet.dll/__explainmodule?url=prlzb_acg_postsave','800506','流程设置');
