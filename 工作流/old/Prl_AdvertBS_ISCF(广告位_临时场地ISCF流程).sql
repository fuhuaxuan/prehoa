...
--4、	定义工作流程名称 ，步骤等
  ...
  values(sEntGid, sModelGid, sModelCode, '广告位_临时场地ISCF', 3, '租户', '1.0', 0, 0);

  insert into WF_Task_Define(EntGid, ModelGid, TaskDefGid, Code, Name, Note, OrderValue, IsStart, IsEnd, IsMCF)
  values(sEntGid, sModelGid, sTaskGid_T1, sModelCode || '_T1', '填写ISCF申请单', '填写', 1, 1, 0, 0);

   insert into WF_Task_Define(EntGid, ModelGid, TaskDefGid, Code, Name, Note, OrderValue, IsStart, IsEnd, IsMCF)
  values(sEntGid, sModelGid, sTaskGid_TMod, sModelCode || '_TMod', '修改ISCF申请单','修改', 1, 0, 0, 0);

  insert into WF_Task_Define(EntGid, ModelGid, TaskDefGid, Code, Name, Note, OrderValue, IsStart, IsEnd, IsMCF)
  values(sEntGid, sModelGid, sTaskGid_TA1, sModelCode || '_TA1', '商场总经理审批','审批', 1, 0, 0, 0);
...
--6、	定义工作流程步骤走向
  ...
  insert into WF_Task_Define_Condition(EntGid, ModelGid, FromTaskDef, ToTaskDef)
  values( sEntGid, sModelGid, sTaskGid_TA2, sTaskGid_TB);
  ...
  insert into WF_Task_Define_Condition(EntGid, ModelGid, FromTaskDef, ToTaskDef)
  values( sEntGid, sModelGid, sTaskGid_TA2, sTaskGid_TCC);
  ...
  insert into WF_Task_Define_Condition(EntGid, ModelGid, FromTaskDef, ToTaskDef)
  values( sEntGid, sModelGid, sTaskGid_TA2, sTaskGid_Tend);
